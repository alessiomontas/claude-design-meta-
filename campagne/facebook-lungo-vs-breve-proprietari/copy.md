...
## Archivio — non pubblicabile

Materiale **ritirato dal consegnabile per decisione del cliente**. Non usare, non inviare al cliente finale, non riprendere in altre campagne senza sbloccare la verifica indicata.

### Gancio B — "Le tasse sui soldi che non hai incassato" (fiscale/morosità)

> L'inquilino non paga da tre mesi.
>
> E su quei canoni che non hai mai visto, le tasse le devi comunque: per i contratti stipulati dal 2020, la detassazione scatta solo dall'intimazione di sfratto o dall'ingiunzione di pagamento. Non è automatica.
>
> Quasi nessuno lo sa prima di trovarcisi dentro.

**Perché è archiviato:** è, nella sostanza, **consulenza fiscale a nome del brand** — esattamente ciò che il brief vieta al post (il fisco entra solo come burocrazia che ci prendiamo noi).
