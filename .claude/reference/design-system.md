...
**Video / reel.** Un reel si consegna come: artboard `.dc.html` una per scena (editabili), PNG in `png/`, video montato e pagina animata in loop. In questo ambiente l'unico encoder disponibile è VP8 (WebM, senza audio): l'MP4 con la musica si fa in CapCut o Canva partendo dal WebM o dai PNG — vedi `montaggio-capcut.md` nella campagna stagionalità come modello di guida al montaggio.
