...
| `facebook-lungo-vs-breve-proprietari` | — (campagna solo Facebook) | **"scheda tecnica / perizia"**: fondo a griglia millimetrata (righe continue oro 6% ogni 60px su scuro, 5,5% ogni 48px su sabbia), **linee di quota da disegno tecnico** (barretta verticale + filo orizzontale + etichetta al centro) per misurare un numero, separatori orizzontali hairline al posto delle card, angoli vivi ovunque (anche la CTA è una banda rettangolare, non una pill), riferimenti normativi in piccolo allineati a destra, intestazione "Scheda 0X / 03"; barre di confronto in **scala proporzionale reale** con etichette LORDI/NETTI; banda scura a piena larghezza per la voce scomoda (utenze); 3ª immagine con banda fotografica reale in alto + quadro condizioni numerato sotto |
