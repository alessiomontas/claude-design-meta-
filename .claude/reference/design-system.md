...
| `presentazione-servizi-hadrianus` | — (nessuna storia, revisione di un reel esistente) | "foto reale piena + fascia scura sfumata in basso": foto a piena pagina con scrim sfumato dal basso, headline Archivo 900 bianca + checklist con spunta oro sopra lo scrim; una slide su cinque rompe il pattern con sfondo gradiente fumè tipografico + card chiara sabbia per varietà; cover reel 9:16 con stessa logica, pillole oro piene come tag di sommario |
